...
public class StreamEx {
    public static void main(String[] args) {
        ...
        //Set에 names에 홍길동, 김나무, 김꽃분 세명의 회원을 저장하고 회원의 이름을 stream을 이용하여 출력하시오
        ...
        Stream<String> users = names.stream();      //스트림 열기
        users.forEach(System.out::println);
        users.forEach(name -> System.out.println("name"));


//        1. 내부 반복자이므로 처리 속도가 빠르다. 병렬 병령 처리에 효율적이다.
//        2. 람다식으로 다양한 요소처리가 가능하다.
//        3. 중건처리와 최종처리를 수행하도록 파이프라인을 형성할 수 있다.
    }
}
